-- ==================================================
-- ucenje verzija: ctrl_decoder_komentarisano.vhd
-- uloga fajla: grubo dekodiranje instrukcije
-- sustina: ovaj modul od opcode polja pravi osnovne kontrolne signale.
-- ne bira jos tacno "andn" ili "clz", nego prvo odredjuje klasu instrukcije.
-- ==================================================
...
architecture behavioral of ctrl_decoder is
   -- Gledamo opcode bez najniza 2 bita jer se tako lakse grupisu klase instrukcija.
...
begin
   ...
   begin
      -- podrazumevano: nema grananja, nema upisa u memoriju, nema write-back
      branch_o      <= '0';
      mem_to_reg_o  <= '0';
      data_mem_we_o <= '0';
      alu_src_o     <= '0';
      ...
      case opcode_i(6 downto 2) is
         ...
         when STORE_OPCODE_C =>         --STORE: sw, sb
            ...
            data_mem_we_o <= '1';
            alu_src_o     <= '1';
         when R_TYPE_OPCODE_C =>        --R type: add, sub, and, or, xor, andn...
            alu_2bit_op_o <= "10";
            rd_we_o       <= '1';
         when I_TYPE_OPCODE_C =>        --I type: addi, xori, slli, clz, ctz...
            alu_2bit_op_o <= "11";
            alu_src_o     <= '1';
            rd_we_o       <= '1';
