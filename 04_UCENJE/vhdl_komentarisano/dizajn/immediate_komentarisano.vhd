-- ==================================================
-- ucenje verzija: immediate_komentarisano.vhd
-- uloga fajla: izdvajanje i prosirenje immediate polja instrukcije
-- sustina: iz instrukcije se vadi konstanta i siri na 32 bita.
-- bez ovog modula ne bi radili addi, load/store offset-i ni branch.
-- ==================================================
...
architecture Behavioral of immediate is
   ...
   -- interno pojednostavljenje: prvo klasifikujemo instrukciju na R/I/S/B tip
...
begin
   ...
   -- prvo odredi tip instrukcije preko opcode polja
   process (opcode) is
   begin
   ...
   -- zatim od tog tipa sastavi 32-bitni immediate
