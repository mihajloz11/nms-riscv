-- ==================================================
-- ucenje verzija: ALU_simple_komentarisano.vhd
-- uloga fajla: stvarno racunanje rezultata instrukcija
-- sustina: kad dekoder izabere operaciju, ovdje se dobija rezultat.
-- za temu rada je ovo jedan od najbitnijih fajlova.
-- ==================================================
...
ARCHITECTURE behavioral OF ALU IS
   -- broji nule od najviseg bita ka nizem
   ...
   -- broji nule od najnizeg bita ka visem
   ...
   -- broji koliko bitova ima vrijednost 1
   ...
   -- sext.b: siri znak iz najnizeg bajta
   ...
   -- sext.h: siri znak iz najnizih 16 bita
...
BEGIN
   ...
   -- ovdje op_i bira koji rezultat stvarno izlazi iz ALU
   res_o <= res_s;
   with op_i select
   ...
   -- zero_o govori da li je rezultat jednak nuli
