...
package alu_ops_pkg is
   ...
   constant and_op : std_logic_vector(4 downto 0) := "00000"; -- bitovski and
   constant or_op : std_logic_vector(4 downto 0) := "00001"; -- bitovski or
   constant xor_op : std_logic_vector(4 downto 0) := "00011"; -- bitovski xor
   constant add_op : std_logic_vector(4 downto 0) := "00010"; -- sabiranje
   constant sub_op : std_logic_vector(4 downto 0) := "00110"; -- oduzimanje
   constant eq_op : std_logic_vector(4 downto 0) := "10111"; -- jednako
   ...
   constant xnor_op : std_logic_vector(4 downto 0) := "11000"; -- xnor
   ...
   constant cpop_op : std_logic_vector(4 downto 0) := "00100"; -- broj jedinica
   constant rol_op : std_logic_vector(4 downto 0) := "11001"; -- rotacija lijevo
   constant ror_op : std_logic_vector(4 downto 0) := "11010"; -- rotacija desno
